/*!
 * bpmn-js - bpmn-navigated-viewer v17.3.0
 *
  ...
  function BpmnRenderer(
    ...
    function renderLane(parentGfx, element, attrs = {}) {
      ...
      if (is$1(semantic, 'bpmn:Lane') && isHorizontal(element) && borderRadius > 0) {
        ...
        var siblingLanes = parent && parent.children
          ? parent.children.filter(function(child) {
            return is$1(child, 'bpmn:Lane');
          }).sort(function(a, b) {
            return a.y - b.y || a.x - b.x;
          })
          : [];

        var isTopLane = siblingLanes[ 0 ] === element,
            isBottomLane = siblingLanes[ siblingLanes.length - 1 ] === element;

        if (isTopLane && isBottomLane) {
