...
## [17.3.0](https://github.com/bpmn-io/bpmn-js/compare/v18.6.1...v17.3.0) (2025-04-25)
...
* allow event rendering without icons ([cd23850](https://github.com/bpmn-io/bpmn-js/commit/cd238502115ee4897421af779b44289dace9d4ca))
* allow text annotations for message flows ([e8f343a](https://github.com/bpmn-io/bpmn-js/commit/e8f343a2e83fee19fceb961b0ac5e6ef03746533)), closes [#2281](https://github.com/bpmn-io/bpmn-js/issues/2281)
* allow to add to selection via lasso tool ([9b2b6a6](https://github.com/bpmn-io/bpmn-js/commit/9b2b6a65d82117966e6b0da6537a1424bab7d6f2))
* allow to replace between variants of typed events ([0a7c5f3](https://github.com/bpmn-io/bpmn-js/commit/0a7c5f38231358014aa3dfc96bbcef5b77cc186a))
* allow to type services and events ([edfec4c](https://github.com/bpmn-io/bpmn-js/commit/edfec4cdc855e35a1b9919df85b3d7ee47419873)), closes [#2121](https://github.com/bpmn-io/bpmn-js/issues/2121)
* auto-place elements vertically ([d9b8bfd](https://github.com/bpmn-io/bpmn-js/commit/d9b8bfd5935439420f4a9cea7f4f386587e7f821)), closes [#2110](https://github.com/bpmn-io/bpmn-js/issues/2110)
* **bpmn-renderer:** allow overriding colors, width, and height ([f77de3b](https://github.com/bpmn-io/bpmn-js/commit/f77de3bc4d1a41a4bded9cc7b14580afdce0924d)), closes [#1990](https://github.com/bpmn-io/bpmn-js/issues/1990)
...
* **context-pad:** preview append on hover ([18b10b2](https://github.com/bpmn-io/bpmn-js/commit/18b10b22c8602a6480fe90d373258cd0fe4f41bc))
...
* do not translate import errors ([ea9318b](https://github.com/bpmn-io/bpmn-js/commit/ea9318b3d59f7adca4f29fd5fc0559243d3cb065))
* do not translate technical errors ([160444e](https://github.com/bpmn-io/bpmn-js/commit/160444eae80ceba94ff63264fb50ee30863fdaaf))
* edit vertical pool/lane labels ([29baeb1](https://github.com/bpmn-io/bpmn-js/commit/29baeb19dd31c4662d5aa788a420a6a9ee29ca0d))
* handle adding vertical lanes ([6e92713](https://github.com/bpmn-io/bpmn-js/commit/6e92713cb904ceff905c44e218e55407710767cb))
* handle resizing of vertical lanes ([0a706be](https://github.com/bpmn-io/bpmn-js/commit/0a706beb19caa5317db89f9a204a15a3d248373f))
* handle splitting vertical lanes ([e263bbb](https://github.com/bpmn-io/bpmn-js/commit/e263bbbfd418294b0fd3b84750fc813a659f9299))
* improve handling of compensation association ([3dbaf50](https://github.com/bpmn-io/bpmn-js/commit/3dbaf503a55703e966b0dae5873d5c5b025d8a4f))
* **label-editing:** remove background for embedded labels ([384fad5](https://github.com/bpmn-io/bpmn-js/commit/384fad529cdddc3a76e5cb16f8846d24dfc6fafd))
* **modeling:** always place annotations on root element ([ca230c3](https://github.com/bpmn-io/bpmn-js/commit/ca230c39c4e7a5f6d32620c783e8748a0b89dd4a))
* **modeling:** disable autoResize for annotation changes ([d2a9760](https://github.com/bpmn-io/bpmn-js/commit/d2a976034b3ae70fce40dd8febc18acac9d8aa8d)), closes [#2049](https://github.com/bpmn-io/bpmn-js/issues/2049)
...
* **modeling:** keep interrupting config when replacing elements ([29f135f](https://github.com/bpmn-io/bpmn-js/commit/29f135f383d330323af4b019870c34e552b7a46e))
* **Ordering:** always render annotations on top ([1108d9d](https://github.com/bpmn-io/bpmn-js/commit/1108d9de22ff55230279ea9e6ccdddd42b31409e))
* **popup-menu:** add non-interrupting toggle ([9c71556](https://github.com/bpmn-io/bpmn-js/commit/9c715569524e27b4543699b270f3fe6e34901895))
...
* position context pad according to last waypoint for connections ([#826](https://github.com/bpmn-io/bpmn-js/issues/826)) ([b6abc5d](https://github.com/bpmn-io/bpmn-js/commit/b6abc5dba880890e46859cf1e2ff731d15dc7efd))
* provide selection outlines ([c3fed8e](https://github.com/bpmn-io/bpmn-js/commit/c3fed8e09b5e9693ca17c203fa27b5bed6493a17)), closes [#1996](https://github.com/bpmn-io/bpmn-js/issues/1996)
* remove selection outline from connections ([#826](https://github.com/bpmn-io/bpmn-js/issues/826)) ([b6abc5d](https://github.com/bpmn-io/bpmn-js/commit/b6abc5dba880890e46859cf1e2ff731d15dc7efd))
* remove touch interaction module ([9b2b6a6](https://github.com/bpmn-io/bpmn-js/commit/9b2b6a65d82117966e6b0da6537a1424bab7d6f2)), closes [#2053](https://github.com/bpmn-io/bpmn-js/issues/2053)
...
* **search:** sort matches by location ([4789c1f](https://github.com/bpmn-io/bpmn-js/commit/4789c1ff4bbd73ec60866c682b0ccc0b5c0f048a))
* support modeling of gateway without marker ([b9d0ce3](https://github.com/bpmn-io/bpmn-js/commit/b9d0ce3e10a502c9209ccb93a3b78eb114d2a906)), closes [#2063](https://github.com/bpmn-io/bpmn-js/issues/2063)
* translate Append TextAnnotation context pad action ([7328955](https://github.com/bpmn-io/bpmn-js/commit/732895554aab7c4be62f358c5bba4b05b2f21597))
* update translations ([c5aea1f](https://github.com/bpmn-io/bpmn-js/commit/c5aea1f604197f3737bf7d82ea91387a209a95b4))


### Bug Fixes

* add accessible label to drill down button ([b4abfaa](https://github.com/bpmn-io/bpmn-js/commit/b4abfaa9d40e1763ca1499cdf68d89329d375b8b))
...
* **align-elements:** fix method name ([3005813](https://github.com/bpmn-io/bpmn-js/commit/300581342286f2f031f22bf2eb79e82bb8913a05))
* allow to create connection + event-based gateway ([47c5213](https://github.com/bpmn-io/bpmn-js/commit/47c521314017bab2e308354a0669323bc24bb11c))
* auto-place elements vertically in sub-processes ([3153b08](https://github.com/bpmn-io/bpmn-js/commit/3153b083f99b12bc0786f75b2114c70ec4b3cea6)), closes [#2127](https://github.com/bpmn-io/bpmn-js/issues/2127)
* **auto-resize:** fix `BpmnAutoResizeProvider` JSDoc ([6cdb960](https://github.com/bpmn-io/bpmn-js/commit/6cdb960ea821cf90bbbedca0965c1b4eb241c567))
* **BaseViewer:** fix `BaseViewerOptions` type ([4fa7102](https://github.com/bpmn-io/bpmn-js/commit/4fa710201aa026d08bc8f5ea534cd99095d341b2))
* **BaseViewer:** inline types ([c83adc9](https://github.com/bpmn-io/bpmn-js/commit/c83adc92286c61eb42e88bd5c626023f85407002))
...
* **BpmnFactory:** fix JSDoc ([78edc64](https://github.com/bpmn-io/bpmn-js/commit/78edc64408f57f33a5ba4872b3a9f4eb9fdce507))
* **BpmnLayouter:** fix JSDoc ([d210d6b](https://github.com/bpmn-io/bpmn-js/commit/d210d6bb466899921ebdbbe7453731c5d92a7986))
* **BpmnUpdater:** fix JSDoc ([75b438c](https://github.com/bpmn-io/bpmn-js/commit/75b438c1579fd93c2a5965f97616f6e8631a7e7e))
...
* **copy-paste:** use `set` to set model properties ([ca65cde](https://github.com/bpmn-io/bpmn-js/commit/ca65cde02c37a5c9db1a121fc3b6edbdc35a3f60)), closes [#1935](https://github.com/bpmn-io/bpmn-js/issues/1935)
* correct `BaseViewer#on` method signature ([2ae9ca8](https://github.com/bpmn-io/bpmn-js/commit/2ae9ca86be9991722c7893bce2a459285b5b3248))
* correct distributed asset path ([3d813de](https://github.com/bpmn-io/bpmn-js/commit/3d813de33b8d6de86e6e568abb783e5adfe0f141)), closes [#1976](https://github.com/bpmn-io/bpmn-js/issues/1976)
* correct various JSDocs ([2ca4907](https://github.com/bpmn-io/bpmn-js/commit/2ca4907d5cd81e5ba3460e52ce459eb847f48021))
* correctly implement `CommandHandler` ([aaea2f8](https://github.com/bpmn-io/bpmn-js/commit/aaea2f8ac5c203fa0040937b3f652a4fea1432b7))
* correctly remove vertical lanes ([df2ae05](https://github.com/bpmn-io/bpmn-js/commit/df2ae0560b7a17c9543043f6a6759ea1e540a821))
* create hit boxes for vertical lanes ([0a2f759](https://github.com/bpmn-io/bpmn-js/commit/0a2f7598f0c054528240d17f1768ddb5ff1e7f55)), closes [#2093](https://github.com/bpmn-io/bpmn-js/issues/2093)
* do not set label on planes ([4451857](https://github.com/bpmn-io/bpmn-js/commit/4451857cbd0d409c6668fea25cb9e61eecec878b)), closes [#2033](https://github.com/bpmn-io/bpmn-js/issues/2033)
* **draw:** correct some JSDocs ([#1898](https://github.com/bpmn-io/bpmn-js/issues/1898)) ([130749e](https://github.com/bpmn-io/bpmn-js/commit/130749e7156b8870e8976b01c407ea9a714432f7))
* **draw:** don't fill multiple parallel events ([ec2ee69](https://github.com/bpmn-io/bpmn-js/commit/ec2ee691dd05ab996ee09dff5c848162f99021aa))
* **draw:** fix `TextRenderer` JSDoc ([65d02ee](https://github.com/bpmn-io/bpmn-js/commit/65d02ee8b498eb70e7b3a11580cd9fade99d36da))
* **draw:** use correct Types in `BpmnRenderUtil` ([#2036](https://github.com/bpmn-io/bpmn-js/issues/2036)) ([1c428f6](https://github.com/bpmn-io/bpmn-js/commit/1c428f6872c033b1d13999499c8729f32638ab25)), closes [#2028](https://github.com/bpmn-io/bpmn-js/issues/2028)
...
* **drilldown:** gracefully handle missing BPMNDiagram#plane ([a66d850](https://github.com/bpmn-io/bpmn-js/commit/a66d85018a71af016210e0a5696d8c7e1fab7304))
* **drilldown:** handle missing process (parent) DI elements ([857415f](https://github.com/bpmn-io/bpmn-js/commit/857415ff465296a73ff6339d342011c3360665e2))
* **ElementFactory:** fix [@extend](https://github.com/extend) ([a8bf319](https://github.com/bpmn-io/bpmn-js/commit/a8bf3192a9f62083cfb902829fccd1a5f388da09))
* **ElementFactory:** fix JSDoc ([42790fe](https://github.com/bpmn-io/bpmn-js/commit/42790fef4870f8bfb66a8516b03c4e05f44ab8fb))
...
* ensure lanes aren't resized when using space tool ([4f6923b](https://github.com/bpmn-io/bpmn-js/commit/4f6923bdc5a2fb37a99c2d54cde93ca91db5f171))
* error info use tagged template ([829989e](https://github.com/bpmn-io/bpmn-js/commit/829989ed888b866fbb0edcae248414a85ea6b70d))
...
* fix behaviors JSDocs ([e24c238](https://github.com/bpmn-io/bpmn-js/commit/e24c238e74a7d420a1cf159c45824e987c06fe04))
* fix breadcrumb styling ([5e3dac7](https://github.com/bpmn-io/bpmn-js/commit/5e3dac72534387aea6034b93cb5f4213bc688c13))
* fix remaining JSDoc and TS errors ([07f75f7](https://github.com/bpmn-io/bpmn-js/commit/07f75f7cd5d2ef9934d7b32cccfee6d4f05b8fc6))
* fix remaining JSDocs ([1d90ae6](https://github.com/bpmn-io/bpmn-js/commit/1d90ae636bc9cad372ac8c71d888e25ad99b4512))
* fix tests failing due to lazy instantiation of `eventDefinitions` ([83c79f0](https://github.com/bpmn-io/bpmn-js/commit/83c79f003c29e2f13d410bcbfebfb94c0d2636e1))
* fix types ([709be3b](https://github.com/bpmn-io/bpmn-js/commit/709be3b192b3e8e0b15a984bd0cb1829a71691cd))
...
* generate types for `index.js` ([a944873](https://github.com/bpmn-io/bpmn-js/commit/a944873de73e9b08516fb4f4d823c77fe1f81edc))
...
* import types as `type` ([#1897](https://github.com/bpmn-io/bpmn-js/issues/1897)) ([fa217fb](https://github.com/bpmn-io/bpmn-js/commit/fa217fbfe497fe93295ca9b3989ea8a82760dadb))
* **import:** handle missing BPMNDiagram#plane ([bc24a60](https://github.com/bpmn-io/bpmn-js/commit/bc24a6092d0368cf988a3e894b2de6845324c2d4))
* improve regex ([4e68036](https://github.com/bpmn-io/bpmn-js/commit/4e68036a086521d2c09cf3814e296da2df3021e8))
* keep direction when collapsing pools ([90c513c](https://github.com/bpmn-io/bpmn-js/commit/90c513c770506e5c04d7fa50d3159ada7b17a618)), closes [#2208](https://github.com/bpmn-io/bpmn-js/issues/2208)
* label text visible while editing ([988cb29](https://github.com/bpmn-io/bpmn-js/commit/988cb29f50218d0bc758fbe2ffe6416192251d8e))
* lane resize constraints for horizontal and vertical lanes ([7a137cc](https://github.com/bpmn-io/bpmn-js/commit/7a137cc502687763965059b1aa7f8a5792d177ee)), closes [#2209](https://github.com/bpmn-io/bpmn-js/issues/2209)
* **LaneUtil:** fix JSDoc ([ff5a465](https://github.com/bpmn-io/bpmn-js/commit/ff5a46543432496fbfc3269b75c527be66113ead))
* **modeler:** fix JSDoc ([208d1fd](https://github.com/bpmn-io/bpmn-js/commit/208d1fd691f42dc53aec3795c5e625ebdccf1dce))
* **Modeler:** re-add outline feature ([9f41690](https://github.com/bpmn-io/bpmn-js/commit/9f41690c22cee6f64c8506313487ee45d108a86e))
* **modeling:** do not remove connection that is being created ([3578990](https://github.com/bpmn-io/bpmn-js/commit/357899036a40ca29c0a8a51e858e21f139d69b0d)), closes [#2068](https://github.com/bpmn-io/bpmn-js/issues/2068)
* **modeling:** fix `ConnectionLayoutUtil` JSDoc ([d2e0b14](https://github.com/bpmn-io/bpmn-js/commit/d2e0b14d3eeb37ca24b7e9d5bb87b1bc76378d05))
* **modeling:** fix `Modeling` types ([bd1fa49](https://github.com/bpmn-io/bpmn-js/commit/bd1fa49de0260d52bffbe6fb4cddf46653b77ea5))
* **modeling:** fix `ResizeBehavior` JSDoc ([56b0054](https://github.com/bpmn-io/bpmn-js/commit/56b0054d66536a777d5f64af028daee49d03c03d))
* **modeling:** fix command handler JSDocs ([7166868](https://github.com/bpmn-io/bpmn-js/commit/716686879cb105083b803ca63a8e65491139d1a2))
* **Modeling:** make generic ([9811bfc](https://github.com/bpmn-io/bpmn-js/commit/9811bfc695e3fe621dc23619b4fa2f6479026965))
* **ModelingUtil:** fix JSDoc ([0676974](https://github.com/bpmn-io/bpmn-js/commit/0676974d86e752ced84ddb968026c07da221fd09))
* **outline:** correct size for end event ([8b18beb](https://github.com/bpmn-io/bpmn-js/commit/8b18bebe7f5137179145dd022e655a8e3e295768)), closes [#2015](https://github.com/bpmn-io/bpmn-js/issues/2015)
* **outline:** customize call activity outline ([07bf015](https://github.com/bpmn-io/bpmn-js/commit/07bf015baa73e7f8ce43b4d7ea459ea33e715962)), closes [#2167](https://github.com/bpmn-io/bpmn-js/issues/2167)
* **outline:** external label resize ([c9f4c83](https://github.com/bpmn-io/bpmn-js/commit/c9f4c8379578e59604e81e7a2fb0d1d99f26ece3)), closes [#2001](https://github.com/bpmn-io/bpmn-js/issues/2001)
* pasting compensation activity without boundary event ([4359f18](https://github.com/bpmn-io/bpmn-js/commit/4359f184098a809a1080384a72addd440cb3b74f)), closes [#2070](https://github.com/bpmn-io/bpmn-js/issues/2070)
* **popup-menu:** correct various accessibility issues ([cf66bc2](https://github.com/bpmn-io/bpmn-js/commit/cf66bc286fa9ec28df9e3a8cca57a63738ed4003))
* **popup-menu:** render on top ([06838aa](https://github.com/bpmn-io/bpmn-js/commit/06838aa80cc63364c133e6ce4094f1fd6916f123))
* prevent access of non-existing connection bounds ([3501c28](https://github.com/bpmn-io/bpmn-js/commit/3501c2806bddacfe59a4cede677bb59eb33c9057))
...
* **replace:** show correct interrupting/non-interrupting entries ([9c5b88d](https://github.com/bpmn-io/bpmn-js/commit/9c5b88d2084db7f03b4f93cb790578c6ada93fa3))
* reposition popup menu if under axis ([4f06be6](https://github.com/bpmn-io/bpmn-js/commit/4f06be63d712ffb32f2d4e64214d78e0ec3d72d9))
* revert selection outline removal for connections ([647dcfc](https://github.com/bpmn-io/bpmn-js/commit/647dcfca28ba8f325f14fe9aa30dceae22424211))
* **search:** correct various minor issues ([72996b3](https://github.com/bpmn-io/bpmn-js/commit/72996b3d4f72124202b51ba28bd80f3145c86c91))
...
* **search:** handle elements without label ([58d7d7a](https://github.com/bpmn-io/bpmn-js/commit/58d7d7a30b16961a6649db82778018c1705f32d4)), closes [#2232](https://github.com/bpmn-io/bpmn-js/issues/2232)
* set loop characteristics in a command ([78af19c](https://github.com/bpmn-io/bpmn-js/commit/78af19c23fa80706e57fa66f7ca182a2637588ad)), closes [#1960](https://github.com/bpmn-io/bpmn-js/issues/1960)
...
* **space-tool:** move artifacts when a participant is resized by space tool ([78d0846](https://github.com/bpmn-io/bpmn-js/commit/78d0846149df00934f0c9e8cdef2b51e40ed8e63))
* **space-tool:** prevent empty pools from getting resized vertically ([736876f](https://github.com/bpmn-io/bpmn-js/commit/736876ff773d79ad80ced45a6a64278a6a01f8d4))
* support core replace in compensation behavior ([11fef5f](https://github.com/bpmn-io/bpmn-js/commit/11fef5f120c94e4d7294f711ace2472dd2a14be9)), closes [#2073](https://github.com/bpmn-io/bpmn-js/issues/2073)
* support rendering of gateway without marker ([b100cdf](https://github.com/bpmn-io/bpmn-js/commit/b100cdfa0b2951cc9b3d5542ebd03cb0d9bfd2cb))
* update label on modeling.updateModdleProperties ([881e2bd](https://github.com/bpmn-io/bpmn-js/commit/881e2bd6ba9bf9d0ffa29cdb46e7a761cf1da53f)), closes [#1872](https://github.com/bpmn-io/bpmn-js/issues/1872)
* **viewer:** fix JSDoc ([8d3208e](https://github.com/bpmn-io/bpmn-js/commit/8d3208ece43f86a1831b9892a6c201f404caeef0))
...
* merge main to develop ([714cde9](https://github.com/bpmn-io/bpmn-js/commit/714cde92126ae1884631acf1edd9017ae34e4c0a))
