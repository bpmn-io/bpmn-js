 ...
 * @template T
 *
 * @typedef { import('diagram-js/lib/core/EventBus.js').default<T> } EventBus
 */

/**
 * @template T
 *
 * @typedef {import('diagram-js/lib/core/EventBus.js').EventBusEventCallback<T>} EventBusEventCallback
 */
 ...
 * @typedef {import('./model/Types.js').ModdleExtension} ModdleExtension
 *
 * @typedef { {
 *   width?: number|string;
