...
Canvas.prototype.removeShape = function(shape) {
  ...
  var gfx = this._elementRegistry.getGraphicsByElement(shape);
   ...
   * @property {Object} gfx the graphical representation of the shape
   */
  this._eventBus.fire('shape.remove', { element: shape, gfx: gfx });
   ...
   * @property {Object} gfx the graphical representation of the shape
   */
  this._eventBus.fire('shape.removed', { element: shape, gfx: gfx });
...
Canvas.prototype.removeConnection = function(connection) {
  ...
  if (_.isString(connection)) {
    connection = this._elementRegistry.getById(connection);
  }

  var gfx = this._elementRegistry.getGraphicsByElement(connection);
   ...
   * @type {Object}
   * @property {djs.Connection} element the connection descriptor
   * @property {Object} gfx the graphical representation of the connection
   */
  this._eventBus.fire('connection.remove', { element: connection, gfx: gfx });
   ...
   * @type {Object}
   * @property {djs.Shape} element the connection descriptor
   * @property {Object} gfx the graphical representation of the connection
   */
  this._eventBus.fire('connection.removed', { element: connection, gfx: gfx });
