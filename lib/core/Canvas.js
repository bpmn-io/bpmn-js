...
function Canvas(config, events, commandStack, graphicsFactory, shapes) {
  ...
  /**
   * Gets or sets the current scale of the canvas, optionally zooming to the specified position.
   *
   * @method Canvas#scale
   * 
   * @param {String|Number} [scale] the new zoom level, either a number, i.e. 0.9,
