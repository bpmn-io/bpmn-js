...
Canvas.prototype.setRootElement = function(element, override) {
  ...
  if (rootElement) {
    ...
    elementRegistry.remove(rootElement, defaultLayer);
  }

  elementRegistry.add(element, defaultLayer);

  return (this._rootElement = element);
};
...
Canvas.prototype.addShape = function(shape, parent) {
  ...
  this._setParent(shape, parent || this.getRootElement());

  // create shape gfx
  var gfx = this._graphicsFactory.createShape(this.getDefaultLayer(), shape);
...
Canvas.prototype.addConnection = function(connection, parent) {
  ...
  this._setParent(connection, parent || this.getRootElement());
...
/**
 * Internal set parent of element
 */
