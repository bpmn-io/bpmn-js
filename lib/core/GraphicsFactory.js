...
GraphicsFactory.prototype._getChildren = function(element) {
  ...
  var gfx = this._elementRegistry.getNativeGraphics(element);
  ...
  if (!element.parent) {
    ...
    if (!childrenGfx) {
      ...
      domClasses(childrenGfx).add('djs-children');
...
GraphicsFactory.prototype._createContainer = function(type, parentGfx) {
  ...
  domClasses(outerGfx).add('djs-group');

  svgAppend(parentGfx, outerGfx);

  var gfx = svgCreate('g');
  domClasses(gfx).add('djs-element');
  domClasses(gfx).add('djs-' + type);
...
GraphicsFactory.prototype.updateContainments = function(elements) {
  ...
  forEach(parents, function(parent) {
    ...
    forEach(children.slice().reverse(), function(c) {
      var gfx = elementRegistry.getNativeGraphics(c);
