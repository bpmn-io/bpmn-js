...
ElementRegistry.prototype.getNative = function(filter) {
  var id;
...
ElementRegistry.prototype.getNativeGraphics = function(filter, secondary) {
  return unwrapSnapSvg(this.getGraphics(filter, secondary));
};
