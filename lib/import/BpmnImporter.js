...
function notYetDrawn(semantic, refSemantic, property) {
  return new Error(_i18n.t('element not yet drawn', {
                    element: elementToString(refSemantic),
                    referenced_by: elementToString(semantic), property: property
                  }));
}
 ...
 */
function BpmnImporter(eventBus, canvas, elementFactory, elementRegistry, i18n) {
...
BpmnImporter.$inject = [ 'eventBus', 'canvas', 'elementFactory', 'elementRegistry', 'i18n' ];
...
BpmnImporter.prototype.add = function(semantic, parentElement) {
  ...
  // CONNECTION
    ...
    throw new Error(i18n.t('unknown di for element', {
                      element_di: elementToString(di),
                      element_semantic: elementToString(semantic)
                    }));
  }
  // (optional) LABEL
...
BpmnImporter.prototype._attachBoundary = function(boundarySemantic, boundaryElement) {
  ...
  if (!hostSemantic) {
    throw new Error(i18n.t('missing #attachedToRef', { boundary_semantic: elementToString(boundarySemantic) }));
  }
...
BpmnImporter.prototype._getEnd = function(semantic, side) {
  ...
  if (refSemantic) {
    ...
    throw new Error(i18n.t('# Ref not specified', {element_semantic: elementToString(semantic), side: side}));
  }
};
