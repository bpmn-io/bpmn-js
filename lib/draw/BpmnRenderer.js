...
export default function BpmnRenderer(
  ...
  function drawDiamond(parentGfx, width, height, attrs) {
    ...
    // diamond edges have slope ±1 — to round each vertex by r along the path,
    // step back r/√2 along each adjacent edge and quadratic-curve through it.
    var r = 4;
    var rd = r / Math.SQRT2;
    ...
    var d = [
      ...
      'Q', x_2, 0, x_2 + rd, rd,
      'L', width - rd, y_2 - rd,
      'Q', width, y_2, width - rd, y_2 + rd,
      'L', x_2 + rd, height - rd,
      'Q', x_2, height, x_2 - rd, height - rd,
      'L', rd, y_2 + rd,
      'Q', 0, y_2, rd, y_2 - rd,
      'Z'
    ].join(' ');
  ...
  function renderLane(parentGfx, element, attrs = {}) {
    var lane = drawRect(parentGfx, getWidth(element, attrs), getHeight(element, attrs), 4, {
      fill: getFillColor(element, defaultFillColor, attrs.fill),
