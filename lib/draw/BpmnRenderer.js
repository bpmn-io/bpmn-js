...
import {
  ...
  transform,
  translate
} from 'diagram-js/lib/util/SvgTransformUtil.js';

import { Ids } from 'ids';

import { black } from './BpmnRenderUtil.js';
 ...
 * @param {import('diagram-js/lib/core/EventBus.js').default} eventBus
 * @param {import('diagram-js/lib/draw/Styles.js').default} styles
 * @param {import('./PathMap.js').default} pathMap
 * @param {import('diagram-js/lib/core/Canvas.js').default} canvas
 * @param {import('./TextRenderer.js').default} textRenderer
