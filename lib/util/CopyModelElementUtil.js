 ...
 */
export default function CopyModelElementUtil(eventBus, bpmnFactory, moddle) {
  this._bpmnFactory = bpmnFactory;
  this._eventBus = eventBus;
  this._moddle = moddle;

  // copy extension elements last
  eventBus.on('element.copyProperties', function(context) {
  ...
  eventBus.on('element.propertyCopied', function(context) {
 ...
 * @param {ModdleElement}
 */
CopyModelElementUtil.prototype.copyElement = function(sourceElement, targetElement, propertyNames) {
  var self = this;
  ...
  var canCopyProperties = this._eventBus.fire('element.copyProperties', {
    propertyNames: propertyNames,
  ...
  forEach(propertyNames, function(propertyName) {
    ...
    var canSetProperty = self._eventBus.fire('element.propertyCopied', {
      parent: parent,
 ...
 * @returns {*}
 */
CopyModelElementUtil.prototype.copyProperty = function(property, parent, propertyName) {
  var self = this;
  ...
  if (copiedProperty) {
    if (isObject(copiedProperty) && copiedProperty.$type) {
