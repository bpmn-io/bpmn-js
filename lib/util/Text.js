...
var wrapSnapSvg = require('./SnapSvgUtil').wrapSnapSvg,
    unwrapSnapSvg = require('./SnapSvgUtil').unwrapSnapSvg;
...
Text.prototype.createText = function(parent, text, options) {
  ...
  svgAppend(unwrapSnapSvg(parent), fakeText);
  ...
  svgAppend(unwrapSnapSvg(parent), textElement);
  ...
  return wrapSnapSvg(textElement);
};
