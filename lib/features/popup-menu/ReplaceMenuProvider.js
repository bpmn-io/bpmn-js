...
import { canBeNonInterrupting, getInterruptingProperty } from '../modeling/behavior/util/NonInterruptingUtil.js';
import Icons from './util/Icons.js';

/**
 * @typedef {import('../modeling/BpmnFactory.js').default} BpmnFactory
 ...
 * @typedef {import('../replace/BpmnReplace.js').default} BpmnReplace
 * @typedef {import('diagram-js/lib/features/Rules.js').default} Rules
 * @typedef {import('diagram-js/lib/i18n/translate/translate.js').default} Translate
 * @typedef {import('../copy-paste/ModdleCopy.js').default} ModdleCopy
 *
 * @typedef {import('../../model/Types.js').Element} Element
 * @typedef {import('../../model/Types.js').Moddle} Moddle
 *
 * @typedef {import('diagram-js/lib/features/popup-menu/PopupMenuProvider.js').PopupMenuEntries} PopupMenuEntries
 * @typedef {import('diagram-js/lib/features/popup-menu/PopupMenuProvider.js').PopupMenuEntry} PopupMenuEntry
 * @typedef {import('diagram-js/lib/features/popup-menu/PopupMenuProvider.js').PopupMenuEntryAction} PopupMenuEntryAction
 * @typedef {import('diagram-js/lib/features/popup-menu/PopupMenuProvider.js').PopupMenuHeaderEntries} PopupMenuHeaderEntries
 * @typedef {import('diagram-js/lib/features/popup-menu/PopupMenuProvider.js').default} PopupMenuProvider
 * @typedef {import('diagram-js/lib/features/popup-menu/PopupMenu.js').PopupMenuTarget} PopupMenuTarget
 *
 * @typedef {import('./ReplaceOptions.js').ReplaceOption} ReplaceOption
 */
