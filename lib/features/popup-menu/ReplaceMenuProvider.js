...
ReplaceMenuProvider.prototype._createMenuEntry = function(definition, element, action) {
  ...
  var menuEntry = {
    label: translate.t(definition.label),
  ...
  var loopEntries = [
    {
      ...
      title: translate.t('Parallel Multi Instance'),
      active: isParallel,
    ...
    },
    {
      ...
      title: translate.t('Sequential Multi Instance'),
      active: isSequential,
      action: toggleLoopEntry,
      options: {
        loopCharacteristics: 'bpmn:MultiInstanceLoopCharacteristics',
