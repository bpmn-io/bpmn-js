 ...
 */
function ReplaceMenuProvider(popupMenu, modeling, moddle, bpmnReplace, rules, i18n) {
...
ReplaceMenuProvider.$inject = [ 'popupMenu', 'modeling', 'moddle', 'bpmnReplace', 'rules', 'i18n' ];
  ...
  var loopEntries = [
    {
      ...
      title: i18n.t('Parallel Multi Instance'),
      active: isParallel,
    ...
    },
    {
      ...
      title: i18n.t('Sequential Multi Instance'),
      active: isSequential,
      action: toggleLoopEntry,
      options: {
        loopCharacteristics: 'bpmn:MultiInstanceLoopCharacteristics',
