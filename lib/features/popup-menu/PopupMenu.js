...
PopupMenu.prototype._bindHandlers = function() {
  ...
  eventBus.once('commandStack.element.updateProperties.executed', close);
  eventBus.once('commandStack.element.updateProperties.reverted', close);
};
...
PopupMenu.prototype._unbindHandlers = function() {
  ...
  eventBus.off('commandStack.element.updateProperties.executed', close);
  eventBus.off('commandStack.element.updateProperties.reverted', close);
};
