 ...
 * });
 *
 * // With popupMenu.updateHeaderEntris() it is possbile to update header entries by id.
 ...
 * popupMenu.updateHeaderEntries([
 *   { id: 'header-entry-a', active: true, disabled: true }
 * ]);
 *
 * // It is also possible to remove these classes:
 * popupMenu.updateHeaderEntries([
 *   { id: 'header-entry-a', active: false, disabled: false }
 * ]);
 *
 *
...
/**
 * Updates attributes of header entries.
 *
 ...
 *
 * popupMenu.updateHeaderEntries([
 *   { id: 'header-entry-a', active: true, disabled: false }
 * ]);
 *
 * @param  {Object} updatedEntries an object containing entry IDs and properties that will be updated
 * @param  {Object} [element] a BPMN element
 * @param  {Object} [updatedProperties] updates the bpmn element with this properties
 */
PopupMenu.prototype.updateHeaderEntries = function (updatedEntries, element, updatedProperties) {

  var headerEntries = this._current.menu.headerEntries;
  var newHeaderEntries = clone(headerEntries, true);

  forEach(updatedEntries, function(updatedEntry){
    var index = findIndex(headerEntries, function(entry) {
    ...
    var entry = newHeaderEntries[index];
    entry.active = updatedEntry.active;
    entry.disabled = updatedEntry.disabled;
  });

  var className = this._current.menu.className || 'popup-menu';
  var containerSelector = '.' + className + ' .djs-popup-header';

  this._modeling.updateEntries(headerEntries, newHeaderEntries, containerSelector,
