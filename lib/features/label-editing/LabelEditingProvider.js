...
LabelEditingProvider.prototype.getEditingBBox = function(element) {
  ...
  var annotationPadding = this._textRenderer.getTextAnnotationPadding(),
  ...
  if (is(element, 'bpmn:TextAnnotation')) {
    ...
    assign(style, {
      textAlign: 'left',
      paddingTop: (annotationPadding * zoom) + 'px',
      paddingBottom: (annotationPadding * zoom) + 'px',
      paddingLeft: (annotationPadding * zoom) + 'px',
      paddingRight: (annotationPadding * zoom) + 'px',
      fontSize: defaultFontSize + 'px',
      lineHeight: defaultLineHeight
    });
  }
