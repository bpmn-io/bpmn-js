 ...
 * @typedef {import('diagram-js/lib/features/resize/ResizeHandles.js').default} ResizeHandles
 * @typedef {import('../../draw/TextRenderer.js').default} TextRenderer
 *
...
LabelEditingProvider.prototype.getEditingBBox = function(element) {
  ...
  if (isLabelExternal(target)
    ...
    var newLabelWidth = DEFAULT_LABEL_SIZE.width * zoom + 2 * BORDER_WIDTH;
  ...
  if (is(element, 'bpmn:TextAnnotation')) {
    ...
    assign(style, {
      textAlign: 'left',
      paddingTop: (TEXT_ANNOTATION_PADDING * zoom) + 'px',
      paddingBottom: (TEXT_ANNOTATION_PADDING * zoom) + 'px',
      paddingLeft: (TEXT_ANNOTATION_PADDING * zoom) + 'px',
      paddingRight: (TEXT_ANNOTATION_PADDING * zoom) + 'px',
      fontSize: defaultFontSize + 'px',
      lineHeight: defaultLineHeight
    });
  }
