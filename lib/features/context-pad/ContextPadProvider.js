...
import {
  isAny
} from '../modeling/util/ModelingUtil.js';

import {
  getChildLanes
} from '../modeling/util/LaneUtil.js';

import {
  hasPrimaryModifier
} from 'diagram-js/lib/util/Mouse.js';

/**
 * @typedef {import('didi').Injector} Injector
 * @typedef {import('diagram-js/lib/core/EventBus.js').default} EventBus
 * @typedef {import('diagram-js/lib/features/context-pad/ContextPad.js').default} ContextPad
 * @typedef {import('../modeling/Modeling.js').default} Modeling
 * @typedef {import('../modeling/ElementFactory.js').default} ElementFactory
 * @typedef {import('../append-preview/AppendPreview.js').default} AppendPreview
 * @typedef {import('diagram-js/lib/features/connect/Connect.js').default} Connect
 * @typedef {import('diagram-js/lib/features/create/Create.js').default} Create
 * @typedef {import('diagram-js/lib/features/popup-menu/PopupMenu.js').default} PopupMenu
 * @typedef {import('diagram-js/lib/features/canvas/Canvas.js').default} Canvas
 * @typedef {import('diagram-js/lib/features/rules/Rules.js').default} Rules
 * @typedef {import('diagram-js/lib/i18n/translate/translate.js').default} Translate
 *
 * @typedef {import('../../model/Types.js').Element} Element
 * @typedef {import('../../model/Types.js').ModdleElement} ModdleElement
 *
 * @typedef {import('diagram-js/lib/features/context-pad/ContextPadProvider.js').default<Element>} BaseContextPadProvider
 * @typedef {import('diagram-js/lib/features/context-pad/ContextPadProvider.js').ContextPadEntries} ContextPadEntries
 * @typedef {import('diagram-js/lib/features/context-pad/ContextPadProvider.js').ContextPadEntry} ContextPadEntry
 *
