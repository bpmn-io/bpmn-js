...
var startEventReplace = [
  {
    ...
    className: 'icon-01-none-start-event',
  ...
  },
  {
    ...
    className: 'icon-01-none-intermediate-throw-event',
  ...
  },
  {
    ...
    className: 'icon-01-none-end-event',
    targetType: 'bpmn:EndEvent'
  },
  {
    label: 'Message Start Event',
    actionName: 'replace-with-message-start',
    className: 'icon-02-message-start-event',
    targetType: 'bpmn:StartEvent',
    options: {
  ...
  },
  {
    ...
    className: 'icon-03-timer-start-event',
    targetType: 'bpmn:StartEvent',
    options: {
  ...
  },
  {
    ...
    className: 'icon-05-conditional-start-event',
    targetType: 'bpmn:StartEvent',
    options:{
  ...
  },
  {
    ...
    className: 'icon-10-signal-start-event',
    targetType: 'bpmn:StartEvent',
    options: {
 ...
 var intermediateEventReplace = [
   ...
   },
   {
     ...
     className: 'icon-02-message-intermediate-event',
   ...
   },
   {
     ...
     className: 'icon-02-message-intermediate-throw-event',
     targetType: 'bpmn:IntermediateThrowEvent',
     options: {
       eventDefinition: 'bpmn:MessageEventDefinition'
     }
   },
   {
     ...
     className: 'icon-03-timer-intermediate-event',
     targetType: 'bpmn:IntermediateCatchEvent',
     options: {
       eventDefinition: 'bpmn:TimerEventDefinition'
     }
   },
   {
     ...
     className: 'icon-04-escalation-intermediate-event',
     targetType: 'bpmn:IntermediateThrowEvent',
     options: {
   ...
   },
   {
     ...
     className: 'icon-05-conditional-intermediate-event',
     targetType: 'bpmn:IntermediateCatchEvent',
     options: {
       eventDefinition: 'bpmn:ConditionalEventDefinition'
     }
   },
   {
     ...
     className: 'icon-06-link-intermediate-event',
     targetType: 'bpmn:IntermediateCatchEvent',
     options: {
   ...
   },
   {
     ...
     className: 'icon-06-link-intermediate-throw-event',
     targetType: 'bpmn:IntermediateThrowEvent',
     options: {
       eventDefinition: 'bpmn:LinkEventDefinition'
     }
   },
   {
     ...
     className: 'icon-09-compensation-intermediate-throw-event',
     targetType: 'bpmn:IntermediateThrowEvent',
     options: {
   ...
   },
   {
     ...
     className: 'icon-10-signal-intermediate-event',
     targetType: 'bpmn:IntermediateCatchEvent',
     options: {
       eventDefinition: 'bpmn:SignalEventDefinition'
     }
   },
   {
     ...
     className: 'icon-10-signal-intermediate-throw-event',
     targetType: 'bpmn:IntermediateThrowEvent',
     options: {
       eventDefinition: 'bpmn:SignalEventDefinition'
     }
...
var endEventReplace = [
  ...
  },
  {
    ...
    actionName: 'replace-with-message-end',
    className: 'icon-02-message-end-event',
    targetType: 'bpmn:EndEvent',
    options: {
      eventDefinition: 'bpmn:MessageEventDefinition'
    }
  },
  {
    ...
    className: 'icon-04-escalation-end-event',
    targetType: 'bpmn:EndEvent',
    options: {
      eventDefinition: 'bpmn:EscalationEventDefinition'
    }
  },
  {
    ...
    className: 'icon-07-error-end-event',
    targetType: 'bpmn:EndEvent',
    options: {
  ...
  },
  {
    ...
    className: 'icon-08-cancel-end-event',
    targetType: 'bpmn:EndEvent',
    options: {
  ...
  },
  {
    ...
    className: 'icon-09-compensation-end-event',
    targetType: 'bpmn:EndEvent',
    options: {
      eventDefinition: 'bpmn:CompensateEventDefinition'
    }
  },
  {
    ...
    className: 'icon-10-signal-end-event',
    targetType: 'bpmn:EndEvent',
    options: {
      eventDefinition: 'bpmn:SignalEventDefinition'
    }
  },
  {
    ...
    className: 'icon-13-terminate-end-event',
    targetType: 'bpmn:EndEvent',
    options: {
...
var gatewayReplace = [
  {
    ...
    className: 'icon-exclusive-gateway',
