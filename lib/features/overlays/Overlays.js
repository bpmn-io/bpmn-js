...
Overlays.prototype.addOverlayToElement = function(overlayName, shape, overlayConfig) {
  ...
  if(overlayName === 'html') {
    ...
    if(overlayConfig.x) {
      ...
      position.scale = overlayConfig.scale;
    }
  } else {
...
/**
 * Adds an simple HTML overlay to an element.
 *
 * @param {Shape} shape - Attach overly to this shape
 * @param {Object} overlayConfig - { html: '<div>Test</div>' }
 */
