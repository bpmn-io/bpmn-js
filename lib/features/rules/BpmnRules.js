...
function canInsert(shape, connection, position) {
  ...
  // the change here is just for debugging as is allows replace to continue trying to insert
  return (
    isAny(connection, [ 'bpmn:SequenceFlow', 'bpmn:MessageFlow', 'bpmn:SubProcess' ]) &&
    !isLabel(connection) &&
