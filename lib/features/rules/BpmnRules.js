...
function canConnectDataAssociation(source, target) {
  ...
  if (isAny(source, [ 'bpmn:DataObjectReference', 'bpmn:DataStoreReference', 'bpmn:DataInput' ]) &&
      isAny(target, [ 'bpmn:Activity', 'bpmn:ThrowEvent' ])) {
    return { type: 'bpmn:DataInputAssociation' };
  }

  if (isAny(target, [ 'bpmn:DataObjectReference', 'bpmn:DataStoreReference', 'bpmn:DataOutput' ]) &&
