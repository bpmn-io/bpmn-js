...
import SpaceTool from 'diagram-js/lib/features/space-tool/SpaceTool.js';

import { getEnclosedElements, getBBox } from 'diagram-js/lib/util/Elements.js';

import { getBusinessObject, is } from '../../util/ModelUtil.js';

import { isHorizontal } from '../../util/DiUtil.js';
