...
function SpaceToolVisuals(eventBus, elementRegistry, canvas, styles) {
  ...
  eventBus.on('spaceTool.bootstrap.start', function(event) {
  ...
  eventBus.on('spaceTool.bootstrap.move', function(event) {
    var crosshairGroup = event.context.crosshairGroup;

    crosshairGroup.translate(event.x, event.y);
  });

  eventBus.on('spaceTool.bootstrap.cleanup', function(event) {
