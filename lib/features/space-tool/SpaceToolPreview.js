...
var PreviewSupport = require('../move/PreviewSupport');
...
function SpaceToolPreview(eventBus, elementRegistry, canvas, styles) {
  PreviewSupport.call(this, elementRegistry, canvas, styles);
  ...
  eventBus.on('spaceTool.move', LOW_PRIORITY, function(event) {
    ...
    if (!context.dragGroup) {
      ...
      forEach(movingShapes, function(shape) {
        self.addDragger(shape, dragGroup);
      ...
      forEach(movingConnections, function(connection) {
        self.addDragger(connection, dragGroup);
    ...
    if (!context.frameGroup) {
      ...
      forEach(resizingShapes, function(shape) {
        var frame = self.addFrame(shape, frameGroup);
...
inherits(SpaceToolPreview, PreviewSupport);

SpaceToolPreview.$inject = [ 'eventBus', 'elementRegistry', 'canvas', 'styles' ];
