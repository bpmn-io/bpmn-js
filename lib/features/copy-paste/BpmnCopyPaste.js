...
export default function BpmnCopyPaste(bpmnFactory, eventBus, injector) {
  ...
  var helper = injector.instantiate(ModelCloneHelper);
  ...
  // TODO: move to CopyPropertiesUtil
  ...
  eventBus.on('element.paste', function(context) {
    ...
    descriptor.businessObject = helper.clone(oldBusinessObject, newBusinessObject);
