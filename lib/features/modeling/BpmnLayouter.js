...
import { isDirectionHorizontal } from './util/ModelingUtil.js';
 ...
 *
 * @typedef {import('diagram-js/lib/layout/BaseLayouter.js').LayoutConnectionHints} LayoutConnectionHints
 *
 * @typedef { {
 *   source?: Element;
 *   target?: Element;
