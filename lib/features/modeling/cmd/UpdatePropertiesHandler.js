 ...
 */
function UpdatePropertiesHandler(elementRegistry, moddle, i18n) {
  this._elementRegistry = elementRegistry;
  this._moddle = moddle;
  this._i18n = i18n;
}

UpdatePropertiesHandler.$inject = [ 'elementRegistry', 'moddle', 'i18n' ];
...
UpdatePropertiesHandler.prototype.execute = function(context) {
  ...
  if (!element) {
    throw new Error(i18n.t('element required'));
  }
