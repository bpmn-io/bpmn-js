 ...
 */
export default function GroupBehavior(bpmnFactory, canvas, elementRegistry, eventBus, injector) {
  injector.invoke(CommandInterceptor, this);

  var copyModelElementUtil = new injector.instantiate(CopyModelElementUtil);
  ...
  eventBus.on('element.copyProperty', HIGH_PRIORITY, function(context) {
    ...
    if (is(property, 'bpmn:CategoryValue')) {
      ...
      return copyModelElementUtil.copyElement(property, bpmnFactory.create('bpmn:CategoryValue'));
    }
  });
