...
import { getBusinessObject, is } from '../../../util/ModelUtil.js';

import CommandInterceptor from 'diagram-js/lib/command/CommandInterceptor.js';
import { hasEventDefinition, isEventSubProcess } from '../../../util/DiUtil.js';
 ...
 * @param {import('../Modeling.js').default} modeling
 * @param {import('../../rules/BpmnRules.js').default} bpmnRules
 */
