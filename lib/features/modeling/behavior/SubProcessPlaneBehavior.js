...
import { getBusinessObject, getDi, is } from '../../../util/ModelUtil.js';

import { getMid } from 'diagram-js/lib/layout/LayoutUtil.js';

import { getBBox, selfAndChildren } from 'diagram-js/lib/util/Elements.js';
 ...
 * @typedef {import('../BpmnFactory.js').default} BpmnFactory
 * @typedef {import('../../../Modeler.js').default} Modeler
