...
import { isAny } from './util/ModelingUtil.js';
...
import { isPlane } from '../../util/DrilldownUtil.js';

import { delta } from 'diagram-js/lib/util/PositionUtil.js';
 ...
 * @typedef {import('diagram-js/lib/layout/CroppingConnectionDocking.js').default} CroppingConnectionDocking
 *
