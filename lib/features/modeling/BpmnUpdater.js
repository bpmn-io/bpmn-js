 ...
 */
function BpmnUpdater(eventBus, bpmnFactory, connectionDocking, i18n) {
...
BpmnUpdater.$inject = [ 'eventBus', 'bpmnFactory', 'connectionDocking','i18n' ];
...
BpmnUpdater.prototype.updateSemanticParent = function(businessObject, newParent) {
  ...
  if (!containment) {
    throw new Error(i18n.t('no parent for'), businessObject, newParent);
  }
