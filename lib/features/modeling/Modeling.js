...
Modeling.prototype.registerHandlers = function(commandStack) {
  ...
  commandStack.registerHandler('connections.move', require('./cmd/MoveConnectionsHandler'));
...
Modeling.prototype.moveConnection = function(connection, delta, newParent) {
  ...
  this._commandStack.execute('connections.move', context);
};


Modeling.prototype.moveConnections = function(connections, delta, newParent) {
...
Modeling.prototype.resizeShape = function(shape, newBBox) {
  var context = {
    shape: shape,
    newBBox: newBBox
  };
