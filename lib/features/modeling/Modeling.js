 ...
 *
 * @module BpmnModeling
 * @augments DiagramModeling
 * @constructor
 * @category bpmn-js
 *
 * @param {import('diagram-js/lib/core/EventBus')} eventBus
 * @param {import('./ElementFactory')} elementFactory
 * @param {import('diagram-js/lib/core/CommandStack')} commandStack
 * @param {import('../rules/BpmnRules')} bpmnRules
 */
