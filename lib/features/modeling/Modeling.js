...
Modeling.prototype.getHandlers = function() {
  ...
  handlers['categoryValue.updateRefs'] = UpdateCategoryValueRefsHandler;
...
/**
 * Update the category references of affected flow elements.
 *
 * @param {Object[]} flowElementEntries The affected flow elements.
 * @param {Object[]} groupEntries The groups that changed.
 */
Modeling.prototype.updateCategoryValueRefs = function(flowElementEntries, groupEntries) {

  this._commandStack.execute('categoryValue.updateRefs', {
    flowElementEntries: flowElementEntries,
