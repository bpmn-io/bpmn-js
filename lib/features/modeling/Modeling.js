...
import UpdateCanvasRootHandler from './cmd/UpdateCanvasRootHandler.js';
import AddLaneHandler from './cmd/AddLaneHandler.js';
import SplitLaneHandler from './cmd/SplitLaneHandler.js';
import ResizeLaneHandler from './cmd/ResizeLaneHandler.js';
import UpdateFlowNodeRefsHandler from './cmd/UpdateFlowNodeRefsHandler.js';
import IdClaimHandler from './cmd/IdClaimHandler.js';
import SetColorHandler from './cmd/SetColorHandler.js';

import UpdateLabelHandler from '../label-editing/cmd/UpdateLabelHandler.js';

/**
 * @typedef {import('../rules/BpmnRules.js').default} BpmnRules
 * @typedef {import('diagram-js/lib/command/CommandStack.js').default} CommandStack
 * @typedef {import('./ElementFactory.js').default} ElementFactory
 * @typedef {import('diagram-js/lib/core/EventBus.js').default} EventBus
 *
 * @typedef {import('diagram-js/lib/features/modeling/Modeling.js').ModelingHints} ModelingHints
 *
 ...
 *
 * @typedef {import('../../util/Types.js').Colors} Colors
 *
 * @typedef { {
 *   removeShape?: boolean;
 * } } UpdateLabelHints
