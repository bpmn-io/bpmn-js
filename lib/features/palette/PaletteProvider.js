...
PaletteProvider.prototype.getPaletteEntries = function() {
  ...
  function createCollapsedEventSubProcess(event) {
    var subProcess = elementFactory.createShape({
      type: 'bpmn:SubProcess',
      x: 0,
      y: 0,
  ...
  assign(actions, {
    ...
    'create.event-subprocess-collapsed': {
      group: 'activity',
      className: 'bpmn-icon-event-subprocess-expanded',
      title: translate('Create collapsed event sub-process'),
      action: {
        dragstart: createCollapsedEventSubProcess,
        click: createCollapsedEventSubProcess
      }
    },
