...
PaletteProvider.prototype.getPaletteEntries = function(element) {
  ...
  assign(actions, {
    'create.start-event': createAction(
      'bpmn:StartEvent', 'event', 'icon-01-none-start'
    ),
    'create.intermediate-event': createAction(
      'bpmn:IntermediateThrowEvent', 'event', 'icon-01-none-intermediate-throwing'
    ),
    'create.end-event': createAction(
      'bpmn:EndEvent', 'event', 'icon-01-none-end'
    ),
    'create.exclusive-gateway': createAction(
      'bpmn:ExclusiveGateway', 'gateway', 'icon-exclusive-gateway-variant-1'
    ),
