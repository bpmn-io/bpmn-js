...
PaletteProvider.prototype.getPaletteEntries = function(element) {
  ...
  assign(actions, {
    'create.start-event': createAction(
      'bpmn:StartEvent', 'event', 'icon-01-none-start-event'
    ),
    'create.intermediate-event': createAction(
      'bpmn:IntermediateThrowEvent', 'event', 'icon-01-none-intermediate-throw-event'
    ),
    'create.end-event': createAction(
      'bpmn:EndEvent', 'event', 'icon-01-none-end-event'
    ),
    'create.exclusive-gateway': createAction(
      'bpmn:ExclusiveGateway', 'gateway', 'icon-exclusive-gateway'
    ),
