...
var PreviewSupport = require('./PreviewSupport');
 ...
 * @param {Styles} styles
 */
function MovePreview(eventBus, elementRegistry, canvas, styles) {
  ...
  function makeDraggable(context, element, addMarker) {
    ...
    self.addDragger(element, context.dragGroup);
  ...
  eventBus.on('shape.move.start', LOW_PRIORITY, function(event) {
    ...
    visuallyDraggedShapes.forEach(function(shape) {
      self.addDragger(shape, context.dragGroup);
    });
...
inherits(MovePreview, PreviewSupport);

MovePreview.$inject = [ 'eventBus', 'elementRegistry', 'canvas', 'styles' ];
