 ...
 */
BpmnAutoResize.prototype.resize = function(target, newBounds, resizeDirections) {

  if (is(target, 'bpmn:Participant')) {
    this._modeling.resizeLane(target, newBounds, null, {
      autoResize: resizeDirections
    });
  } else {
    this._modeling.resizeShape(target, newBounds, null, {
      autoResize: resizeDirections
    });
  }
};