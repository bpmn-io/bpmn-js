...
import { isLabel, isExternalLabel } from '../../util/LabelUtil.js';
...
/**
 * @typedef { import('diagram-js/lib/features/outline/OutlineProvider.js').default } BaseOutlineProvider
 *
 * @typedef { import('diagram-js/lib/features/outline/OutlineProvider.js').Outline } Outline
 *
 * @typedef { import('diagram-js/lib/draw/Styles.js').default } Styles
 *
