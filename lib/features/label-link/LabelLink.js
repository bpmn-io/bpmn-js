...
import { createLine, updateLine } from 'diagram-js/lib/util/RenderUtil.js';
import { getMid, getElementLineIntersection } from 'diagram-js/lib/layout/LayoutUtil.js';
import { getDistancePointPoint } from 'diagram-js/lib/features/bendpoints/GeometricUtil.js';
import { isLabel } from 'diagram-js/lib/util/ModelUtil.js';

import { isAny } from '../modeling/util/ModelingUtil.js';
import { getRoundRectPath, getCirclePath } from '../../draw/BpmnRenderUtil.js';
 ...
 * @typedef {import('diagram-js/lib/core/GraphicsFactory.js').default} GraphicsFactory
 * @typedef {import('../outline/OutlineProvider.js').default} Outline
 * @typedef {import('diagram-js/lib/features/selection.js').default} Selection
 *
