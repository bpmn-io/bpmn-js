 ...
 */
function BpmnOrderingProvider(eventBus, i18n) {
  ...
  function findActualParent(element, newParent, containers) {
    ...
    if (!actualParent) {
      throw new Error(i18n.t('no parent for in', { whatfor: element.id, whatin: newParent.id}));
    }
...
BpmnOrderingProvider.$inject = [ 'eventBus', 'i18n' ];
