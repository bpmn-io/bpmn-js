...
function InteractionEvents(eventBus, elementRegistry, styles, snap) {
  ...
  function registerEvents(svg) {
     ...
     * @property {Event} originalEvent
     */
    svg.click(mouseHandler('element.click'));
     ...
     * @property {Event} originalEvent
     */
    svg.dblclick(mouseHandler('element.dblclick'));
     ...
     * @property {Event} originalEvent
     */
    svg.mousedown(mouseHandler('element.mousedown'));
     ...
     * @property {Event} originalEvent
     */
    svg.mouseup(mouseHandler('element.mouseup'));
  }
