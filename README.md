...
The best platform to view and edit BPMN 2.0 diagrams in the browser.
...
Use the [pre-packaged](https://github.com/bpmn-io/bpmn-js-examples/tree/master/pre-packaged) library
